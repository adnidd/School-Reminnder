    ...
    <div class="bg-white shadow-lg rounded-3xl p-10 w-96 flex flex-col items-center">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="w-full">
            ...
            <div class="flex items-center w-full border border-[#132442] rounded-xl px-3 py-2 mb-2">
                <img src="<?php echo e(asset('images/ri_lock-password-line.png')); ?>" class="w-5 h-5 mr-2">
                <input id="password" name="password" type="password" placeholder="Password"
                    class="w-full focus:outline-none text-[#132442] placeholder-[#C1C1C1] text-[16px] font-medium"
                    required>

                <button type="button" id="togglePassword">
                    <img id="eyeIcon" src="<?php echo e(asset('images/solar_eye-bold.png')); ?>" class="w-5 h-5 ml-2">
                </button>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\GitHub\School-Reminnder\resources\views\auth\login.blade.php ENDPATH**/ ?>