...
<div class="container">
    ...
    <nav class="w-full flex justify-between items-center px-10 py-4 shadow-sm">
        ...
        <div class="hidden md:flex space-x-7 text-[#1B2A4E] font-medium">
            <a href="<?php echo e(route('welcome')); ?>" class="hover:text-[#3A71C1]">Home</a>
            ...
            <a href="<?php echo e(route('reminder')); ?>" class="text-white bg-[#3A71C1] px-4 py-1 rounded-full">Reminder</a>
...
<?php /**PATH C:\xampp\htdocs\GitHub\School-Reminnder\resources\views\reminder-student.blade.php ENDPATH**/ ?>