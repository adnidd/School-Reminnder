    ...
    <div id="main" class="hidden">
        ...
        <nav class="w-full flex justify-between items-center px-10 py-4 shadow-sm">
            ...
            <div class="hidden md:flex space-x-7 text-[#1B2A4E] font-medium">
                <a href="<?php echo e(route('homestudent')); ?>" class="text-white bg-[#3A71C1] px-4 py-1 rounded-full">Home</a>
                <a href="<?php echo e(route('task')); ?>" class="hover:text-[#3A71C1]">Task</a>
                <a href="<?php echo e(route('calendar')); ?>" class="hover:text-[#3A71C1]">Calendar</a>
        ...
        <section class="px-10 mt-20 flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="max-w-xl">
                <div class="flex items-center gap-2 bg-[#3A71C1] text-white rounded-full px-4 py-1 w-fit">
                    <div class="w-4 h-4 rounded-full"></div>
                        <img src="<?php echo e('images/rocket.png'); ?>" alt="Rocket Icon" class="w-4 h-4">
            ...
            <div class="mt-10 md:mt-0 md:ml-10">
                ...
                <img src="<?php echo e(asset('images/hero-image.png')); ?>" alt="Hero Image"
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center shadow-md">
                    <div
                        ...
                        <img src="<?php echo e(asset('images/classplanner.png')); ?>" alt="ClassPlanner" class="w-8">
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center shadow-md">
                    <div
                        class="w-16 h-16 mx-auto rounded-full bg-gradient-to-b from-white to-gray-300 flex items-center justify-center shadow">
                        <img src="<?php echo e(asset('images/bell.png')); ?>" alt="Bell" class="w-8">
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center shadow-md">
                    <div
                        class="w-16 h-16 mx-auto rounded-full bg-gradient-to-b from-white to-gray-300 flex items-center justify-center shadow">
                        <img src="<?php echo e(asset('images/teacher.png')); ?>" alt="Teacher" class="w-8">
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center shadow-md">
                    <div
                        class="w-16 h-16 mx-auto rounded-full bg-gradient-to-b from-white to-gray-300 flex items-center justify-center shadow">
                        <img src="<?php echo e(asset('images/book.png')); ?>" alt="Book" class="w-8">
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center shadow-md">
                    <div
                        class="w-16 h-16 mx-auto rounded-full bg-gradient-to-b from-white to-gray-300 flex items-center justify-center shadow">
                        <img src="<?php echo e(asset('images/alert.png')); ?>" alt="Alert" class="w-8">
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center shadow-md">
                    <div
                        class="w-16 h-16 mx-auto rounded-full bg-gradient-to-b from-white to-gray-300 flex items-center justify-center shadow">
                        <img src="<?php echo e(asset('images/history.png')); ?>" alt="History" class="w-8">
                    </div>
        ...
        <footer class="bg-[#E4E4E4] py-10 text-center">
            ...
            <div class="flex justify-center gap-4 mt-6">
                <img src="<?php echo e(asset('images/X-logo.png')); ?>" alt="X" class="w-6">
                <img src="<?php echo e(asset('images/instagram.png')); ?>" alt="Instagram" class="w-6">
                <img src="<?php echo e(asset('images/facebook.png')); ?>" alt="Facebook" class="w-6">
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\GitHub\School-Reminnder\resources\views\homestudentlog.blade.php ENDPATH**/ ?>