...
<body class="flex flex-col items-center justify-center min-h-screen">
  ...
  <!-- Logo -->
  <div class="mb-6">
    <img src="<?php echo e('icon/school-reminder.png'); ?>" alt="School Reminder Logo" class="h-10">
  </div>
  ...
  <div class="bg-white shadow-lg rounded-3xl p-10 w-96 flex flex-col items-center">
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="w-full">
      ...
      <p class="text-graycustom text-[14px] font-medium mt-4">
        ...
        <a href="<?php echo e(route('login')); ?>" class="text-[#132442] font-medium">Login</a>
      </p>
    </form>
...
</html><?php /**PATH C:\xampp\htdocs\GitHub\School-Reminnder\resources\views\signup.blade.php ENDPATH**/ ?>