...
<body class="flex flex-col items-center justify-center min-h-screen">
  ...
  <!-- Logo -->
  <div class="mb-6">
    <img src="<?php echo e(asset('school-reminder-logo.jpg')); ?>" alt="School Reminder Logo" class="h-10">
  ...
  <div class="bg-white shadow-lg rounded-3xl p-10 w-96 flex flex-col items-center">
    ...
    <form id="loginForm" action="#" class="w-full">
      ...
      <div class="flex items-center w-full border border-[#132442] rounded-xl px-3 py-2 mb-4">
        <img src="<?php echo e(asset('images/gridicons_user.png')); ?>" class="w-5 h-5 mr-2">
      ...
      <div class="flex items-center w-full border border-[#132442] rounded-xl px-3 py-2 mb-2">
        <img src="<?php echo e(asset('icons/ri_lock-password-line.png')); ?>" class="w-5 h-5 mr-2">
        <input id="password" name="password" type="password" placeholder="Password"
          class="w-full focus:outline-none text-[#132442] placeholder-[#C1C1C1] text-[16px] font-medium">

        <button type="button" id="togglePassword">
          <img id="eyeIcon" src="<?php echo e(asset('icons/solar_eye-bold.png')); ?>" class="w-5 h-5 ml-2">
        </button>
      </div>
    ...
    <p class="text-graycustom text-[14px] font-medium mt-4">
      ...
      <a href="<?php echo e(route('signup')); ?>" class="text-[#132442] font-medium">Sign Up</a>
    </p>
  ...
  <script>
    ...
    loginForm.addEventListener('submit', (e) => {
      ...
      window.location.href = "<?php echo e(route('homestudent.guest')); ?>";
    });
  </script>

</body>

</html><?php /**PATH C:\xampp\htdocs\GitHub\School-Reminnder\resources\views\login2.blade.php ENDPATH**/ ?>