...
<body class="bg-gray-50 text-gray-800">
    ...
    <nav class="w-full flex justify-between items-center px-10 py-4 shadow-sm">
        ...
        <div class="hidden md:flex space-x-7 text-[#1B2A4E] font-medium">
            ...
            <a href="<?php echo e(route('calendar')); ?>" class="text-white bg-[#3A71C1] px-4 py-1 rounded-full">Calendar</a>
...
</html><?php /**PATH C:\xampp\htdocs\GitHub\School-Reminnder\resources\views\welcome.blade.php ENDPATH**/ ?>